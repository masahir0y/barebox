...
#define UNIPHIER_NR_ENABLED_SOCS		\
	IS_ENABLED(CONFIG_MACH_PH1_SLD3) +	\
	IS_ENABLED(CONFIG_MACH_PH1_LD4) +	\
	IS_ENABLED(CONFIG_MACH_PH1_PRO4) +	\
	IS_ENABLED(CONFIG_MACH_PH1_SLD8) +	\
	IS_ENABLED(CONFIG_MACH_PH1_PRO5) +	\
	IS_ENABLED(CONFIG_MACH_PROXSTREAM2) +	\
	IS_ENABLED(CONFIG_MACH_PH1_LD6B)
...
#endif
#if defined(CONFIG_MACH_PH1_PRO5)
	return SOC_UNIPHIER_PH1_PRO5;
#endif
#if defined(CONFIG_MACH_PROXSTREAM2)
	return SOC_UNIPHIER_PROXSTREAM2;
#endif
#if defined(CONFIG_MACH_PH1_LD6B)
